...
@Service // declaramos esta clase como un componente de servicio de spring (en el
			// contexto), es un estereotipo de component, para que sea un componente del
			// framework
public class ClienteServiceImpl implements IClienteService {

	@Autowired // Inyecta el cliente dao y queda guardada en el contenedor de Spring (en el
				// contexto)
	...
	@Override
	@Transactional(readOnly = true) // de lectura, porque se va a consultar por el.
